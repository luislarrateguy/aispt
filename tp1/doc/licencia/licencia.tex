...
\multirow{5}{*}{\parbox{280pt}{Copiar, distribuir, exhibir, y ejecutar la
obra.}} \\ \\ \\ \\ \\
\multirow{5}{*}{\includegraphics{licencia/remix.jpg}} &
\multirow{5}{*}{\parbox{280pt}{Hacer obras derivadas.}} \\ \\ \\ \\
\end{tabular}\newline\newline

\noindent Bajo las siguientes condiciones:\newline
\begin{tabular}[t]{rl}
\multirow{5}{*}{\includegraphics{licencia/by.jpg}} &
\multirow{5}{*}{\parbox{280pt}{\textbf{Atribución.} Usted debe atribuir la
obra en la forma especificada por el autor o el licenciante.}} \\ \\ \\ \\ \\
\multirow{5}{*}{\includegraphics{licencia/sa.jpg}} &
\multirow{5}{*}{\parbox{280pt}{\textbf{Compartir Obras Derivadas Igual.} Si
